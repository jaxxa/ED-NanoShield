    ...
    class ShieldPawn : Pawn
    {
        ...
        */
        ...
        public override string GetInspectString()
        {
            if (this.ShieldState == ShieldStatePawn.Active)
            {
                return "Shields: " + this.m_energy + " / " + this.maxEnergy + Environment.NewLine + base.GetInspectString();
            }
            else if (this.ShieldState == ShieldStatePawn.Charging)
            {
                return "Shields Charging: " + this.m_energy + " / " + this.maxEnergy + Environment.NewLine + base.GetInspectString();
            }
